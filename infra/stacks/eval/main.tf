...
# Refuse any non-TLS access, matching the state / corpus / web buckets. Eval run
# payloads can contain prompt and response data, so hold them to the same
# in-transit-encryption bar as the other buckets.
